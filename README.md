...
* [🚀 Como Executar o Projeto](#-como-executar-o-projeto)  
  * [🌐 Opção 1 — GitHub Codespaces](#-opção-1--github-codespaces)  
  * [🌐 Opção 2 — Ngrok (Alternativa Rápida)](#-opção-2--ngrok-alternativa-rápida)  
...
Este projeto está sob a licença **MIT**.# 🔐 Melt_Engenharia_Social
